...
const roles = require("/home/sd/wwou/util/roles.js")
...
// map({
//   sitemap: "/home/sd/wwou/public/sitemap.xml",
//   robots: "/home/sd/wwou/public/robots.txt",
//   generate: app,
...
module.exports = client => {
  client.on("ready", async () => {
    ...
    app.get("/logs", checkAuth, viewLogs, async (req, res) => {
      ...
      let files = fs.readdirSync("/home/sd/wwou/logs")
      files = files.filter(
    ...
    app.get("/log/:id", checkAuth, viewLogs, async (req, res) => {
      ...
      let fulllog = fs.readFileSync(`/home/sd/wwou/logs/${file}`, "utf8")
      // console.log(fulllog)
