            ...
            if (
              ...
              fn.getUser(client, cupid.id).send(
                new Discord.MessageEmbed()
                  ...
                  .setDescription(
                    `${cupid.usedAbilityTonight.length == 2 ? `You have now made ` : ``}**${lovers[0].number} ${nicknames.get(
                      lovers[0].id
                    )}** and **${lovers[1].number} ${nicknames.get(
                      lovers[1].id
...
//                     )
            ...
            for (var x = 0; x < game.players.length; x++) {
              ...
              if (game.players[x].nightmared) game.players[x].nightmared = false
            }
          }
