  ...
  run: async (client, message, args, shared) => {
    ...
    if (input == "Invalid date")
      return await message.channel.send(
        "You inputted an invalid date. Please try again."
      )
    ...
    let embed = new Discord.MessageEmbed()
      ...
      .setDescription(
        `${message.author} will be hosting a βTesting Session at [${time} HKT](https://www.thetimezoneconverter.com/?t=${time}&tz=Hong%20Kong&) on ${date}.`
      )
