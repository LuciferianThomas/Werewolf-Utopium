...
const commandFiles = fs.readdirSync('/home/utopium/wwou//commands/items').filter(file => file.endsWith('.js'))
for (const file of commandFiles) {
  const command = require(`/home/utopium/wwou/commands/items/${file}`)
