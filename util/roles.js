...
let roles = {
  ...
  "Aura Seer": {
    desc:
      "Each night you can select a player to uncover their alignment: Good, Evil, or Unknown." +
  ...
  "Beast Hunter": {
    desc:
      "At night you can place a trap on a person which will become active the following night." +
    ...
    cgp: "250c",
    nite:
      "Select a player to place your trap on (`w!trap [player]`). You can place the trap on yourself.",
    tag:
      tags.ROLE.VILLAGER |
      tags.ROLE.REGULAR_VILLAGER |
      tags.ROLE.SEEN_AS_VILLAGER |
  ...
  Bodyguard: {
    desc:
      "You can choose one player to protect every night." +
  ...
  Cupid: {
    desc:
      "During the first night you can select two players to be a love couple." +
    ...
    cgp: "50r",
    nit1:
      "Select two players to be a love couple (`w!lovers [player1] [player2]`)." +
      " If you do not select two players, they will be randomly selected.",
    tag:
      tags.ROLE.VILLAGER |
      tags.ROLE.SEEN_AS_VILLAGER |
      tags.ROLE.WWO_ROLE |
      tags.ROLE.TO_BE_TESTED |
      tags.ROLE.ONE_ONLY,
  },
  Cursed: {
    desc:
  ...
  Detective: {
    ...
    cat: "Strong Villager",
    nite:
      "Select two players to uncover if they are in the same team (`w!detect [player1] [player2]`).",
    cgp: "250c",
    tag:
      tags.ROLE.VILLAGER |
  ...
  Doctor: {
    desc:
      "Choose a player to protect every night." +
  ...
  "Flower Child": {
    desc:
      "You are a villager who can once protect a player from being lynched by the village.",
    aura: "Good",
    team: "Village",
    abbr: ["fc", "flower"],
    cat: "Regular Villager",
    day:
      "You can once protect a player from being lynched by the village (`w!protect [player]`).",
    attr: { abil1: 1 },
    cgp: "75c",
    tag:
      tags.ROLE.VILLAGER |
  ...
  Forger: {
    desc:
      "You can forge two shields and then a sword." +
    ...
    tag:
      ...
      tags.ROLE.SEEN_AS_VILLAGER |
      tags.ROLE.WWO_ROLE |
      tags.ROLE.UNAVAILABLE,
  },
  "Fortune Teller": {
    desc:
      "You have two cards which you can give to other players at night." +
    ...
    cat: "Strong Villager",
    nite:
      "Select a player to give your card to (`w!card [player]`).\n" +
  ...
  "Grumpy Grandma": {
    desc:
      "After the first night you can select a player who cannot talk or vote during the day.",
    aura: "Good",
    team: "Village",
    abbr: ["granny", "gg"],
    cat: "Regular Villager",
    nit1: "Nothing to do. Go back to sleep!",
    nite:
      "Select a player who cannot talk or vote during the day (`w!mute [player]`).",
    cgp: "75c",
    tag:
      tags.ROLE.VILLAGER |
      tags.ROLE.REGULAR_VILLAGER |
  ...
  Gunner: {
    desc:
      "You have two bullets which you can use to kill somebody." +
    ...
    cat: "Strong Villager",
    day:
      "Select a player to kill (`w!shoot [player]`) if you find them suspicious.\n" +
  ...
  Jailer: {
    desc:
      "Select a target each day to put in jail during the next night." +
    ...
    oneOnly: true,
    day:
      "Select a player to put in jail during the next night (`w!jail [player]`).",
    attr: { abil1: 1 },
    tag:
      tags.ROLE.VILLAGER |
      tags.ROLE.STRONG_VILLAGER |
  ...
  Loudmouth: {
    desc:
      "You can select a player who's role will be revealed when you are killed.",
    aura: "Good",
    team: "Village",
    abbr: ["lm"],
    cat: "Regular Villager",
    day:
      "Select a player to be revealed when you are killed (`w!reveal [player]`).",
    nite:
      "Select a player to be revealed when you are killed (`w!reveal [player]`).",
    // attr: { abil1: 1 },
    cap: "75c",
  ...
  Marksman: {
    desc:
      "At night you can mark a player as your target." +
    ...
    cat: "Regular Villager",
    day:
      "Kill your target (`w!shoot`) if you find them suspicious.\n" +
      "**⚠️ If your target is a villager, your shot will backfire and kill you!**",
    nite:
      "Mark a player as your target (`w!mark [player]`).\n" +
  ...
  Mayor: {
    ...
    abbr: [],
    day:
      "You can reveal your role (`w!reveal mayor`) to make your vote count double during the rest of the game.",
    attr: { abil1: 1 },
    cgp: "75c",
    tag:
      tags.ROLE.VILLAGER |
  ...
  Medium: {
    desc:
      "During the night you can talk anonymously with the dead." +
    ...
    cat: "Strong Villager",
    nite:
      "You can talk anonymously with the dead." +
  ...
  Pacifist: {
    desc:
      "Once per game you can reveal the role of a player and prevent anybody from voting during that day.",
    aura: "Good",
    team: "Village",
    abbr: ["paci"],
    cat: "Regular Villager",
    day:
      "You can reveal the role of a player (`w!reveal [player]`) and prevent anybody from voting during that day.\n" +
  ...
  Priest: {
    desc:
      "You can throw holy water on another player." +
    ...
    cat: "Regular Villager",
    day:
      "You can throw holy water on another player (`w!water [player]`) if you find them suspicious.\n" +
  ...
  "Red Lady": {
    desc:
      "At night you can visit another player." +
    ...
    cat: "Regular Villager",
    nite:
      "You can visit another player (`w!visit [player]`)." +
      " If you are attacked while visiting, you will not be killed.\n" +
  ...
  Sheriff: {
    desc:
      "At night you can select someone to watch." +
  ...
  "Spirit Seer": {
    desc:
      "Each night you can select two players." +
    ...
    cat: "Regular Villager",
    nite:
      "Select two players to see if either of them has killed tonight (`w!check [player1] [player2]`).",
    cgp: "25r",
    tag:
      tags.ROLE.VILLAGER |
      tags.ROLE.REGULAR_VILLAGER |
  ...
  Witch: {
    desc:
      "You have two potions: One will kill and the other will protect a player." +
    ...
    cat: "Regular Villager",
    nit1:
      "Select a player to heal with your protect potion (`w!heal [player]`).",
    nite:
      "Select a player to heal with your protect potion (`w!heal [player]`) or to kill with your poison potion (`w!poison [player]`).\n" +
  ...
  Werewolf: {
    ...
    cat: "Werewolf",
    nite:
      "Chat and vote with the werewolves on who to kill tonight (`w!vote [player]`).",
    tag:
      tags.ROLE.WEREWOLF |
  ...
  "Demon Wolf": {
    ...
    abbr: ["demonwolf", "demw"],
    cat: "Werewolf",
    ideaBy: "598296973342146576",
    nite:
      "Vote to kill a player with the werewolves (`w!vote [player]`).\nIf you haven't already, you can also select a player to upgrade (`w!upgrade [player]`).",
    tag:
      tags.ROLE.WEREWOLF |
      tags.ROLE.SEEN_AS_WEREWOLF |
      tags.ROLE.WU_ROLE |
  ...
  "Guardian Wolf": {
    desc:
      "You are a werewolf who can once protect a player from being lynched by the village.",
    aura: "Evil",
    team: "Werewolves",
    abbr: ["gww", "wwg", "gw", "wg"],
    cat: "Werewolf",
  ...
  "Junior Werewolf": {
    desc:
      "Because you are so cute, you can select another player to be killed when you are killed.",
    aura: "Evil",
    team: "Werewolves",
  ...
  "Kitten Wolf": {
    desc:
      "You are a werewolf with the ability to convert a villager into a werewolf." +
  ...
  "Lone Wolf": {
    desc:
      "You are a regular werewolf, except you only win if you are the last werewolf alive.",
    aura: "Unknown",
    team: "Solo",
    abbr: ["lw"],
    nite:
  ...
  "Nightmare Werewolf": {
    desc:
      'Twice during the game you can select a player during the day to "fall asleep" for one night .' +
    ...
    cat: "Werewolf",
    day:
      'You can select a player during the day to "fall asleep" for one night (`w!nightmare [player]`).',
    nite:
      "Chat and vote with the werewolves on who to kill tonight (`w!vote [player]`).",
    attr: { abil1: 2 },
    cgp: "250c",
  ...
  "Shadow Wolf": {
    desc:
      "Once per game you can double your team's votes during the day, while hiding all votes.",
    aura: "Evil",
    team: "Werewolves",
  ...
  "Werewolf Berserk": {
    desc:
      'Once per game, you can active a werewolves "frenzy" during the day.' +
    ...
    cat: "Werewolf",
    day:
      'Once per game, you can active a werewolves "frenzy" during the day (`w!frenzy`).',
    nite:
      "Chat and vote with the werewolves on who to kill tonight (`w!vote [player]`).",
    attr: { abil1: 1 },
    cgp: "25r",
  ...
  "Wolf Shaman": {
    desc:
      "During the day you can enchant another player." +
  ...
  Headhunter: {
    desc:
      "Your goal is to get your target lynched by the village." +
  ...
  Instigator: {
    desc:
      "Choose 2 people each night. If those 2 players are voting each other at the end of the voting phase you win.",
    aura: "Unknown",
    team: "Solo",
    abbr: ["instigate"],
    cat: "Voting",
    nite:
      "Choose two players to instigate hate between for the next day. (`w!instigate [player1] [player2]`)",
    day: "Try to get the two players you chose to be voting each other",
    ideaBy: "544360819790577676",
    tag:
      tags.ROLE.SOLO_VOTING |
      tags.ROLE.SEEN_AS_VILLAGER |
      tags.ROLE.WU_ROLE |
      tags.ROLE.OTHER_ROLE |
      tags.ROLE.TO_BE_TESTED,
    wrt: "544360819790577676",
  },
  "Soul Collector": {
    desc:
      "At night select a number of players to collect their souls if they die from villagers or werewolves." +
    ...
    cat: "Voting",
    nite:
      "Select a number of players to collect their souls (`w!collect [player] ...`).",
    tag:
      tags.ROLE.SOLO_VOTING |
      tags.ROLE.SEEN_AS_VILLAGER |
      tags.ROLE.WWOWC_ROLE |
      tags.ROLE.AVAILABLE |
      tags.ROLE.ONE_ONLY,
  ...
  Accomplice: {
    desc:
      "The Bandit can convert another player to be their accomplice at night." +
    ...
    abbr: ["band", "bd"],
    cat: "Killer",
    tag: tags.ROLE.SOLO_KILLER | tags.ROLE.WWO_ROLE | tags.ROLE.UNAVAILABLE,
  },
  Arsonist: {
    desc:
      "Each night you can either select two players to douse with gasoline, or ignite all doused players which kills them." + // alias: w!burn
    ...
    cat: "Killer",
    nite:
      "Select two players to douse with gasoline (`w!douse [player1] [player2]`) or" +
      " ignite all doused players (`w!ignite`).",
    cgp: "1000c",
    tag: tags.ROLE.SOLO_KILLER | tags.ROLE.WWO_ROLE | tags.ROLE.AVAILABLE,
  },
  Bandit: {
    desc:
      "Find an Accomplice by converting a player at night. Together you can kill one player each night." +
  ...
  Bomber: {
    desc:
      "At night you can place a bomb which will explode during the following night." +
  ...
  Corruptor: {
    desc:
      'Every night you can select one player to "glitch".' +
  ...
  Cannibal: {
    desc:
      "Each night you can either kill a player by eating him or save up your hunger to eat 5 players in one night." +
      " You cannot be killed by the werewolves." +
      " You win if you are the last player alive.",
    aura: "Unknown",
    team: "Solo",
    ...
    cat: "Killer",
    nite:
      'Select a player to "eat" (`w!eat [player1]`) or save up your hunger.',
    attr: { abil1: 1 },
    cgp: "1000c",
    tag: tags.ROLE.SOLO_KILLER | tags.ROLE.WWO_ROLE | tags.ROLE.AVAILABLE,
  },
  Dazzler: {
    desc:
      "Every other night, you can kill two players." +
    ...
    abbr: ["dazz", "dazzle"],
    cat: "Killer",
    ideaBy: "600206664527773708",
    graphicsBy: "699677225523478541",
    nite: 'Select a player to "dazzle" (`w!dazzle [player1]`).',
    tag:
      tags.ROLE.SOLO_KILLER |
      tags.ROLE.WU_ROLE |
      tags.ROLE.OTHER_ROLE |
      tags.ROLE.UNAVAILABLE,
  },
  Illusionist: {
    desc:
      "Each night you can disguise a player." +
  ...
  "Sect Leader": {
    desc:
      "Every night you can convert a player to join your sect." +
    ...
    cat: "Killer",
    nite:
      "Select a player to be converted into your sect (`w!sect [player]`)." +
      " You cannot convert werewolves and solo killers.",
    oneOnly: true,
    cgp: "1000c",
    tag:
  ...
  Zombie: {
    desc:
      "Each night you can bite a player which will turn that player into a zombie at the end of the next night." +
  ...
  "Random Regular Villager": {
    desc:
      "One of: Villager, Aura Seer, Avenger, Beast Hunter, Bodyguard, Doctor, Flower Child," +
  ...
  "Random Strong Villager": {
    desc:
      "One of: Detective, Forger, Fortune Teller, Gunner, Jailer, Medium or Seer",
    abbr: ["rsv"],
    cat: "Random",
    tag: tags.ROLE.AVAILABLE,
    cgp: "250c",
  ...
  "Random Killer": {
    desc:
      "One of: Arsonist, Bomber, Corruptor, Cannibal, Illusionist," +
  ...
  "Amulet of Protection Holder": {
    desc:
      "You are a regular villager, but you cannot be killed by the werewolves.",
  ...
  Doppelganger: {
    desc:
      "During the first night you can select a player. If this player dies, you will take their role.",
    abbr: ["actor"],
    aura: "Unknown",
    team: "Village",
    nit1:
      "Select a player to take their role after they die (`w!inherit [player]`).",
    tag: tags.ROLE.SEEN_AS_VILLAGER | tags.ROLE.WWC_ROLE | tags.ROLE.AVAILABLE,
    wrt: "358980322047688704",
  },
  Drunk: {
    desc:
      "You are a regular villager, but you can't speak properly becuase you are drunk. You can still place a vote during the voting session.",
    abbr: ["cheers", "beer"],
    aura: "Good",
    team: "Village",
    tag: tags.ROLE.SEEN_AS_VILLAGER | tags.ROLE.WWC_ROLE | tags.ROLE.AVAILABLE,
  ...
  Idiot: {
    desc:
      "You are a regular villager, but if you get lynched, you do not die, but instead your role will be shown to the other players. You cannot vote for the rest of the game if this happens.",
    abbr: ["stupid"],
    aura: "Good",
    team: "Village",
    tag:
      tags.ROLE.SEEN_AS_VILLAGER | tags.ROLE.WWC_ROLE | tags.ROLE.UNAVAILABLE,
  },
  "Handsome Prince": {
    desc:
      "You are a regular villager, but if you get lynched, you do not die, but instead your role will be shown to the other players.",
    abbr: ["prince"],
    aura: "Good",
    team: "Village",
    tag: tags.ROLE.SEEN_AS_VILLAGER | tags.ROLE.WWC_ROLE | tags.ROLE.AVAILABLE,
  ...
  "Leprous Human": {
    desc:
      "You are a regular villager. If the werewolves kill you, they cannot kill the next night.",
    abbr: [],
    aura: "Unknown",
    team: "Village",
    tag:
  ...
  "Little Girl": {
    desc:
      "Each night, you can decide to open your eyes. If you open your eyes, you have a chance of detecting a werewolf." +
  ...
  "Lone Wolf": {
    desc:
      "You are a regular werewolf, but you only win if you are the last werewolf alive.",
    abbr: [],
    aura: "Unknown",
    team: "Solo",
    tag:
      tags.ROLE.SEEN_AS_WEREWOLF | tags.ROLE.WWC_ROLE | tags.ROLE.UNAVAILABLE,
  },
  "Mad Scientist": {
  ...
  Mason: {
    desc:
      "You are a regular villager, but you know the other Masons in the village.",
    abbr: ["bob", "builder"],
    aura: "Good",
    team: "Village",
    tag: tags.ROLE.SEEN_AS_VILLAGER | tags.ROLE.WWC_ROLE | tags.ROLE.AVAILABLE,
  ...
  "Naughty Boy": {
    desc:
      "Once during the game, you can select two players to have their roles switched. This ability comes into action the next night.",
    abbr: [],
    aura: "Unknown",
    team: "Village",
    attr: { abil1: 1 },
  ...
  "Sect Hunter": {
    desc:
      "Each night you can select a player. If that player is in the Sect, they die.",
    abbr: [],
    aura: "Unknown",
    team: "Village",
    tag:
...
for (const [key] of Object.entries(roles)) roles[key].name = key
