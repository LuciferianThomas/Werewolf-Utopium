...
let roles = {
  ...
  "Potion Connoisseur": {
    desc: "Every night select a player, you will receive a different potion depending on their aura without knowing what potion it is." +
          " You can kill, mute or role block for a day.",
    aura: "Unknown",
    team: "Village",
    abbr: ["pc","conn","potion guy"],
    cat : "Strong Villager",
    nit1: "You can select a player to extract essence from (`w!extract [player]`) and brew a potion with it.",
