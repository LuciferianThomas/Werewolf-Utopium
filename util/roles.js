module.exports = {
  ...
  "Aura Seer": {
    desc:
      "Each night you can select one player to see whether this player is good, evil or unknown (`w!check [player]`)." + // alias: w!see
  ...
  Avenger: {
    desc:
      "You can select a player to be avenged on when you die (`w!avenge [player]`).",
    aura: "Good",
    team: "Village",
    abbr: ["hunter"]
  },
  "Beast Hunter": {
    desc:
      "At night you can set a trap on a person (`w!trap [player]`). The trap activates on the following night." +
  ...
  Bodyguard: {
    desc:
      "Each night you can select one player to protect (`w!protect [player]`). You automatically protect yourself." +
  ...
  Cupid: {
    desc:
      "During the first night, select 2 players to be a couple with (`w!couple [player1] [player2]`). They will know each other's roles at the beginning of the next day." +
  ...
  Cursed: {
    desc:
      "You are a regular villager until the werewolves kill you at which point, you become a werewolf." +
  ...
  Detective: {
    desc:
      "Every night, select two players to check if they belong to the same team with (`w!detect [player]`)." +
  ...
  "Flower Child": {
    desc:
      "Once a game, you can protect anyone from being lynched by using (`w!petal [player]`).",
    aura: "Good",
    team: "Village",
    abbr: ["fc"]
  },
  "Fortune Teller": {
    desc:
      "During the first night, give two cards to two players with (`w!givecards [player1] [player2]`)." +
  ...
  "Grumpy Grandma": {
    desc:
      "After the first night, select a player to mute with (`w!mute [player]`). This player won't be able to talk or vote the next day." +
  ...
  Gunner: {
    desc:
      "During the day, you have two bullets which you can use them to shoot players by doing (`w!shoot [player]`)." +
  ...
  Jailer: {
    desc:
      "Every day, select one player to jail by doing (`w!jail [number]`)." +
  ...
  Marksman: {
    desc:
      "During the night, select one player to mark with (`w!mark [player]`)." +
  ...
  Mayor: {
    desc:
      "Once a game, you can reveal your role with (`w!reveal`) and your vote will count as double.",
    aura: "Good",
    team: "Village",
    abbr: []
  },
  ...
  Pacifist: {
    desc:
      "Once a game, you can reveal one player with (`w!reveal [player]`) and skip the voting session.",
    aura: "Good",
    team: "Village",
    abbr: ["paci"]
  },
  President: {
    desc:
      "Your role is revealed to everyone. If you die the village loses." +
  ...
  Priest: {
    desc:
      "Once per game, you can throw holy water at one player (`w!water [player]`). You can only do this during the day." +
  ...
  "Red Lady": {
    desc:
      "Every night, you can choose to visit a player with (`w!visit [player]`)." +
  ...
  Seer: {
    desc:
      "Every night, you uncover the role of one player with (`w!check [player]`).", // alias: w!see
    aura: "Good",
    team: "Village",
    abbr: []
  },
  "Seer Apprentice": {
    desc:
      "You start out as an ordinary villager with no special powers." +
  ...
  Sheriff: {
    desc:
      "Every night, select a player to look at with (`w!lookout [player]`)." +
  ...
  "Spirit Seer": {
    desc:
      "Every night, watch 2 players with (`w!watch [player]`)." +
  ...
  "Tough Guy": {
    desc:
      "During the night, you can select one player to protect (`w!defend [player]`)." + // alias: w!protect
  ...
  Witch: {
    desc:
      "You have 2 potions that you can use at night." +
  ...
  Werewolf: {
    desc:
      "You are a regular werewolf with no special abilities. Do `w!vote [player]` to vote with your werewolf teammates.",
    aura: "Evil",
    team: "Werewolves",
    abbr: ["ww"]
  },
  "Alpha Werewolf": {
    desc:
      "You are a regular werewolf except when you vote with the werewolves (`w!vote [player]`), your vote counts as double!",
    aura: "Unknown",
    team: "Werewolves",
    abbr: ["aww", "alpha"]
  },
  "Guardian Wolf": {
    desc:
      "Once a game, you can protect anyone from being lynched by doing (`w!guard [player]`).",
    aura: "Evil",
    team: "Werewolves",
    abbr: ["gww"]
  },
  ...
  "Kitten Wolf": {
    desc:
      "You can select can choose a player to convert a player to the Werewolves team (`w!scratch [player]`)." +
  ...
  "Nightmare Werewolf": {
    desc:
      "Each day you can select a player to be numbed at night (`w!numb [player]`). That player cannot use their abilities that night.",
    aura: "Evil",
    team: "Werewolves",
    abbr: ["nww"]
  },
  Sorcerer: {
    desc:
      "Each night you can see the roles of a player (`w!check [player]`)." +
  ...
  "Werewolf Berserk": {
    desc:
      "Once per game you can announce a Werewolves 'frenzy' during the day." +
  ...
  "Wolf Seer": {
    desc:
      "Each night you can uncover the role of one player (`w!check [player]`)." +
  ...
  "Wolf Shaman": {
    desc:
      "Each night, you can vote on a player to kill (`w!vote [player]`) and talk with the other werewolves." +
  ...
  Headhunter: {
    desc:
      "Your only goal is to get your target lynched by the village." +
  ...
  Arsonist: {
    desc:
      "Each night, you can douse 2 players with gasoline (`w!douse [player]`) or ignite doused players by doing (`w!ignite`)." + // alias: w!burn
  ...
  Bomber: {
    desc:
      "At night, place a bomb on 3 players vertically, horizontally or diagonally (`w!placebomb [player]`)." +
  ...
  Corruptor: {
    desc:
      "Every night, select a player 'glitch' by doing (`w!glitch [player]`)." +
  ...
  Cannibal: {
    desc:
      "Every night, you can kill a player or save up your hunger to kill more the next night by doing (`w!eat [player]`)." +
  ...
  Illusionist: {
    desc:
      "Every night, select a player to disguise." +
  ...
  "Sect Leader": {
    desc:
      "Every night, select a player to convert into a Sect Member with (`w!sect [player]`). You can only convert villagers to the Sect Team." +
  ...
  "Serial Killer": {
    desc:
      "Each night, stab one player with (`w!stab [player]`)." + // alias: w!kill
      " You cannot be killed by the werewolves. You win if you are the last player alive.",
    aura: "Unknown",
    team: "Solo",
    abbr: ["sk"]
  ...
  Zombie: {
    desc:
      "Each night, select a player to convert to a Zombie by (`w!zombify [player]`). Only players from the Village team can be converted." +
